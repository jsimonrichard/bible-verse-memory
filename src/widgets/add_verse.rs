...
impl AddVerseWidget {
    ...
    pub fn render(&self, frame: &mut Frame) {
        ...
        let header = Paragraph::new("Add New Memory Verse")
            .style(
                Style::default()
                    .fg(Color::Cyan)
        ...
        let ref_block = Block::default()
            .borders(Borders::ALL)
            .title("Reference (e.g., John 3:16 or Romans 8:28-30)")
    ...
    pub fn handle_key(&mut self, key: KeyEvent) -> AddVerseAction {
        self.error_message = None;

        match (key.modifiers, key.code) {
            (_, KeyCode::Esc) => return AddVerseAction::Cancel,
            (KeyModifiers::CONTROL, KeyCode::Char('s')) => return AddVerseAction::Save,
